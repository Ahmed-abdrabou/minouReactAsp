...
import "./EditeProductDashboard.css";
const EditeProductDashboard = ({ product, closeEditProduct }) => {
  ...
  //---------------------   load on   ----------------------------------------
  // useEffect(() => {
  //   (async () => await editeProduct(product))();
  // }, []);
  ...
  return (
    <form className="modal-content">
      ...
      <div className="form_content">
        ...
        <div className="form_element_textarea">
...
export default EditeProductDashboard;
